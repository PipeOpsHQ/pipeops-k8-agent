...
func initConfig() {
    ...
    setters := []jsonSetter{
        func() error {
            ...
            if err := json.Unmarshal([]byte(raw), &v); err != nil { return fmt.Errorf("invalid GATEWAY GWAPI listeners JSON: %w", err) }
        ...
        func() error {
            ...
            if err := json.Unmarshal([]byte(raw), &v); err != nil { return fmt.Errorf("invalid GATEWAY GWAPI TCP routes JSON: %w", err) }
        ...
        func() error {
            ...
            if err := json.Unmarshal([]byte(raw), &v); err != nil { return fmt.Errorf("invalid GATEWAY GWAPI UDP routes JSON: %w", err) }
        ...
        func() error {
            ...
            if err := json.Unmarshal([]byte(raw), &v); err != nil { return fmt.Errorf("invalid GATEWAY ISTIO servers JSON: %w", err) }
        ...
        func() error {
            ...
            if err := json.Unmarshal([]byte(raw), &v); err != nil { return fmt.Errorf("invalid GATEWAY ISTIO TCP routes JSON: %w", err) }
        ...
        func() error {
            ...
            if err := json.Unmarshal([]byte(raw), &v); err != nil { return fmt.Errorf("invalid GATEWAY ISTIO TLS routes JSON: %w", err) }
