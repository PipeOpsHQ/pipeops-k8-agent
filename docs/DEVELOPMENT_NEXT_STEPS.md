...
func NewControlPlaneClient(apiURL, token, agentID string) (*ControlPlaneClient, error)
func (c *ControlPlaneClient) Register(ctx context.Context, info AgentInfo) error
func (c *ControlPlaneClient) SendHeartbeat(ctx context.Context, status AgentStatus) error
func (c *ControlPlaneClient) ReportStatus(ctx context.Context, clusterStatus ClusterStatus) error
func (c *ControlPlaneClient) FetchCommands(ctx context.Context) ([]Command, error)
func (c *ControlPlaneClient) SendCommandResult(ctx context.Context, cmdID string, result CommandResult) error
```
